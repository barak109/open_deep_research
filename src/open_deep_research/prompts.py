...
- If your response contains Mermaid markdown, verify and validate its syntax and ensure compliance with mermaid.parse() before returning. Output only a valid Mermaid code block, with no extra text or commentary.
</Writing Guidelines>
